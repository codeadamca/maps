...
error_log("[CERAMIC_MUG] GET /design/can-cooler/$id");

try {

    $templatePath = __DIR__ . "/../designs/can-coolepng";
    $templatePath = false;

    $guidePath = __DIR__ . "/../guides/can-cooler.png";
    $guidePath = false;
    ...
    $start = 760 + ( 450 -
        ...
        $gapA - $gapB - $gapC - 
        $rectWidth - 
        $logoFontSize - $logoFontSize - $logoGapA - $logoGapB);
